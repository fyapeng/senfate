import { ANALYSIS_RESPONSE_SCHEMA, type ApiAnalysisResponse, type ApiLocation, type ApiSex } from "@senfate/contracts";

export const ANALYSIS_SESSION_KEY="senfate.analysis-workbench.v1";
