...
export interface ReferenceCalculationResult {
  readonly schema:"senfate-reference-calculation.v1";
...
export class ReferenceCalculationRuntime {
  ...
  calculate(input:Readonly<{natal:FourPillarState;luck?:GanZhi;annual?:GanZhi;luckDirection?:string;sex?:string}>):ClosedResult<ReferenceCalculationResult,ReferenceCalculationFailure>{
    ...
    return{ok:true,value:{schema:"senfate-reference-calculation.v1",normalForm:normal.value,resolvedFeatures,topicCertificate},certificate:{functional:"reference.calculation-runtime",model:`${this.model.id}@${this.model.version}`,phase:resolvedFeatures.phase,normalFormFingerprint:normal.value.fingerprint,topicCertificate:topicCertificate.schema}};
  }
}
