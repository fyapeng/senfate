...
it("audits the complete resolved topic program",()=>{
  ...
  expect(ambiguousSymbolAbundance).toHaveLength(475);expect(executable.some(record=>record.conditions.some(condition=>condition.operator==="symbol.abundant"))).toBe(false);
