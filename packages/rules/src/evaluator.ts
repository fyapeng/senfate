import { finiteSignedMeasure,kleeneAnd,type FiniteSignedMeasure,type KleeneTruth } from "@senfate/core";
...
export function evaluateReferenceContributions(records:readonly CompiledReferenceRecord[],snapshot:ReferenceFeatureSnapshot):ContributionCertificate{
