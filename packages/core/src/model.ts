...
export const MODEL_PROFILE_SCHEMA="senfate-model-profile.v1" as const;
...
const relationBase:Record<RelationKind,number>={"stem-combine":1,"branch-combine":1,"branch-clash":1,"branch-harm":.75,"branch-break":.6,"three-harmony":1.5,"three-meeting":1.5};
const domainWeights=Object.fromEntries(DOMAIN_KEYS.map(key=>[key,1]));

export const TRANSPARENT_BASELINE_MODEL:SenFateModelProfile={schema:MODEL_PROFILE_SCHEMA,id:"transparent-baseline",version:"0.2.0",label:"透明综合基准",calendar:{useApparentSolarTime:true,dayBoundary:"zi-initial",daysPerLuckYear:3},elementMeasure:{visiblePosition:{year:.8,month:1.15,day:1,hour:.85},hiddenRank:{main:1,middle:.55,residual:.3},seasonalMultiplier:seasonalTable(1.35)},strength:{sameElement:1,resource:1,output:1,wealth:1,officer:1,rootBonus:.15,thresholds:{veryWeakUpper:.25,weakUpper:.42,strongLower:.58,veryStrongLower:.75}},relationResolution:{basePriority:relationBase,completeness:1,seasonalSupport:1,exposure:.75,rootedness:.75,currentLayer:1,effectiveThreshold:2.5,transformThreshold:4,conflictMargin:.25,maxIterations:64},climate:{temperature:1,humidity:1,seasonalCommand:1},topics:{domainWeights,unresolvedContribution:0}};
export const MONTH_COMMAND_MODEL:SenFateModelProfile={...TRANSPARENT_BASELINE_MODEL,id:"month-command",label:"月令结构优先",elementMeasure:{...TRANSPARENT_BASELINE_MODEL.elementMeasure,visiblePosition:{...TRANSPARENT_BASELINE_MODEL.elementMeasure.visiblePosition,month:1.5},seasonalMultiplier:seasonalTable(1.65)},relationResolution:{...TRANSPARENT_BASELINE_MODEL.relationResolution,seasonalSupport:1.35}};
export const CLIMATE_PRIORITY_MODEL:SenFateModelProfile={...TRANSPARENT_BASELINE_MODEL,id:"climate-priority",label:"调候优先",climate:{temperature:1.6,humidity:1.6,seasonalCommand:1.35}};
